...
export default function AdminCalendarPage() {
  ...
  useEffect(() => {
    ...
    const sampleEvents: Event[] = [
      ...
      {
        id: uuidv4(),
        title: 'Workshop: Event Planning 101',
        description: 'Learn the basics of event planning and management',
        start: nextWeek,
        end: nextWeek,
    ...
    sampleEvents.push({
      ...
      description: 'This event spans multiple days to test our calendar',
      start: multiDayStart,
      end: multiDayEnd,
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.description}>
            Manage and schedule all your events in one place
          </p>
        ...
        {/* Permission Requests Section - Admin Access */}
        <PermissionRequests
